                ...
                <div class="row g-2">
                    <div class="col-sm-4">
                        <div class="search-box">
                            <input type="text" class="form-control" id="searchRoleList" placeholder="Search Role">
                    ...
                    <div class="col-sm-auto ms-auto">
                        <div class="list-grid-nav hstack gap-1">
                            <button class="btn btn-success addrole-modal" data-toggle="modal" data-target="#addroleModal"><i class="ri-add-fill me-1 align-bottom"></i>Create role</button>
                        </div>
                    </div>
                    <!--end col-->
                </div>
                                    ...
                                    <form autocomplete="off" id="memberlist-form" class="needs-validation" novalidate>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="p-1 mb-3">
                                                    <h5 class="modal-title text" id="createRoleLabel">Add new Role</h5>
                                                    <h5 class="modal-title text" hidden id="editRoleLabel">Edit Role</h5>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="roleName" class="form-label">Name</label>
                                                    <input type="text" class="form-control" id="roleName" placeholder="Insert Name" required>
                                ...
                                <div class="modal-body">
                                    <div class="mt-2 text-center">
                                        ...
                                        <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                            <h4>Are you sure?</h4>
                                            <p class="text-muted mx-4 mb-0">Are you sure to remove</p>
                                        </div>
                                    </div>
                                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                        <button type="button" class="btn w-sm btn-light" id="close-roleItem" data-dismiss="modal">Close</button>
