                            ...
                            <div class="row">\
                                <div class="col text-end dropdown">\
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">\
                                        <li><a class="dropdown-item edit-list" href="#addroleModal"  data-bs-toggle="modal" data-edit-id="'+roleData.id+'"><i class="ri-pencil-line me-2 align-bottom text-muted"></i>Edit</a></li>\
